  ...
  mobj_t*	thing )
{
	...
	break;
      ...
      case 16:
	// Close Door 30
	EV_DoDoor(line,vldoor_close30ThenOpen);
	line->special = 0;
	break;
	...
	EV_DoDoor (line,vldoor_blazeRaise);
	line->special = 0;
	break;
	
      case 109:
	// Blazing Door Open (faster than TURBO!)
	EV_DoDoor (line,vldoor_blazeOpen);
	line->special = 0;
	break;
	...
	EV_DoDoor (line,vldoor_blazeClose);
	line->special = 0;
	break;
